...
public class Config {
    ...
    public static final String MAIN_WINDOW_NAME = "Line drawer v0.8";
    ...
    public static final String SAVE_BUTTON_ICON = "resources/images/button_save.png";
    public static final String CLEAR_ALL_BUTTON_ICON = "resources/images/button_clear_all.png";
    public static final String INFO_BUTTON_ICON = "resources/images/button_info.png";
    public static final String SOLVE_BUTTON_ICON = "resources/images/button_solve.png";
